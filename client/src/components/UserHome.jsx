...
import imgMech from "./img/ux.png";
import imgRequest from "./img/destination.png";
import imgProfile from "./img/phone.png";
import newcomplaint from "./img/bg-img/planning.png";
import viewcomplaint from "./img/bg-img/analysis.png";
            ...
            <div className="col-6 col-md-6">
              <div className="card horizontal-product-card">
                <div className="card-body d-flex align-items-center">
                  ...
                  <Link  style={{color:"darkblue"}} to="/view_insurance_user">
                   View Insurance Plans </Link> 
                    </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-6">
              <div className="card horizontal-product-card">
                <div className="card-body d-flex align-items-center">
                  ...
                  <Link  style={{color:"darkblue"}} to="/view_claim_user">
                 View My Claim Status</Link> 
                    </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-6">
              <div className="card horizontal-product-card">
                <div className="card-body d-flex align-items-center">
                  ...
                  <Link  style={{color:"darkblue"}} to="/post_feedback_user">
                  Add Feedback </Link> 
                    </div>
                </div>
              </div>
            ...
            <div className="col-6 col-md-6">
              <div className="card horizontal-product-card">
                ...
                <div className="card-body"><img src={imgProfile} className="img-fluid" style={{width:64, height:64}} />{" "}
                  <Link  style={{color:"darkblue"}} to="/view_contact_user">
                   Contact Agent </Link> 
                    </div>
                </div>
              </div>
